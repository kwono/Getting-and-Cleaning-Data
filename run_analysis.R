...
## Subset the features, taking only the mean and standard deviation for the measurements, sort in ascending order, and store the result in features_mod.
...
## Match column names in complete_data with the rows in the second column in features_mod to extract only the columns in complete_data that have the same names. Store the result in complete_data_mod.
features_mod["V3"] <- NA 
